...
import {
	ITVAggregateCreditsQuery,
	ITVAggregateCreditsResponse,
} from '@/models/tmdb/tv/tvAggrateCredits';
import { ITVAltTitlesQuery, ITVAltTitlesResponse } from '@/models/tmdb/tv/tvAltTitles';
import {
	ITVContentRatingsQuery,
	ITVContentRatingsResponse,
} from '@/models/tmdb/tv/tvContentRatings';
...
import {
	ITVRecommendationsQuery,
	ITVRecommendationsResponse,
} from '@/models/tmdb/tv/tvRecommendations';
import { ITVReviewsQuery, ITVReviewsResponse } from '@/models/tmdb/tv/tvReviews';
import {
	ITVScreenedTheatricallyQuery,
	ITVScreenedTheatricallyResponse,
} from '@/models/tmdb/tv/tvScreenedTheatrically';
...
import {
	ITVWatchProvidersQuery,
	ITVWatchProvidersResponse,
} from '@/models/tmdb/tv/tvWatchProviders';
...
export const tvApi = createApi({
	...
	endpoints: (builder) => ({
		...
		getTvScreenedTheatrically: builder.query<
			ITVScreenedTheatricallyResponse,
			ITVScreenedTheatricallyQuery
		>({
			query: ({ series_id }) => ({
